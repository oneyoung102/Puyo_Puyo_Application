...
class puyoPhaseControll
{
    ...
    public :
        puyoPhaseControll(size_t player_count = 0);
        ...
        int do_after_puyo_dropped(puyoPlayer& player, PLAYPUYO&& new_puyos, int gravity_value, int stay_value);
        ...
        void reset_all_chain(puyoPlayer& player);
};