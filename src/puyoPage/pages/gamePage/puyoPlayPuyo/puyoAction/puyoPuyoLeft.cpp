...
bool puyoPuyoLeft::test(puyoBoard& board, puyoPlayPuyo& puyo)
{
...
puyoPuyoLeft::puyoPuyoLeft(int amount, float dist) : puyoPuyoAct(amount){this->dist = dist;}

void puyoPuyoLeft::act(puyoPlayPuyo& puyo)
{
    const auto[x1,y1,x2,y2] = puyo.get_pos();
