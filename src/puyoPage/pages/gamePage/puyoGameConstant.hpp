...
namespace puyoGameConstant
{
    ...
    const std::vector<int> OBSTRUCT_VIEWER_UNIT = {1,6,30,180,360,720,1440};
    ...
    const std::vector<POSf> PLAYER_BOARD_POS = {POSf(31,35),POSf(TWO_BOARD_BREADTH+31,35)};
    const int BOARD_HEIGHT = 12;

    const std::vector<POSf> NEXT_PUYO_VIEWER_POS = {POSf(244,62),POSf(367,62)};
    ...
    const std::vector<POSf> OBSTRUCT_VIEWER_POS = {POSf(31,2),POSf(TWO_BOARD_BREADTH+31,2)};

    const std::vector<POSf> SCORE_POS = {POSf(246,204),POSf(255,256)};

    const std::vector<POSf> TEXT_CHAIN_POS = {{126,205},{TWO_BOARD_BREADTH+126,205}};
    const int TEXT_CHAIN_SIZE = 29, TEXT_CHAIN_TICK = 150;
    const std::vector<POSf> TEXT_ALL_CLEAR_POS = {{126,241},{TWO_BOARD_BREADTH+126,241}};
