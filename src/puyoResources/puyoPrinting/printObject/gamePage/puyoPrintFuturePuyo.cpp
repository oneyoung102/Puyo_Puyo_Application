...
puyoPrintFuturePuyo::puyoPrintFuturePuyo(vector<puyoFuturePuyo>& future_puyos, Sprite puyo, int x, int y, int life) : puyoPrintObject(puyo,x,y,life), future_puyos(future_puyos)
{
...
void puyoPrintFuturePuyo::print_object(RenderWindow& w)
{
    ...
    {
        const auto puyo = future_puyo.get_puyo_type();
